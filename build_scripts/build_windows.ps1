...
Write-Output "   ---"
pip wheel --use-pep517 --use-feature=in-tree-build --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .
...
electron-packager . chia-blockchain --asar.unpack="**\daemon\**" --overwrite --icon=.\src\assets\img\chia.ico --app-version=$packageVersion
Write-Output "   ---"
